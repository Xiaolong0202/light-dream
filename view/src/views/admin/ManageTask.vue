<template>
  ...
  >
    <div>
      ...
      <el-link type="primary" @click="onAddQuestion(4)" style="margin-left: 10px;margin-bottom: 10px">添加矩阵</el-link>
      <el-link type="primary" @click="onAddQuestion(5)" style="margin-left: 10px;margin-bottom: 10px">添加量表</el-link>
      <el-button type="primary" @click="submit" style="float: right;margin-bottom: 20px;margin-right: 10px">保存问题</el-button>
    </div>
    <div id="problem">
    </div>
  </el-dialog>
